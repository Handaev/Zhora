...
public class WorkflowConversionServiceImageIT extends BaseIntegrationTest {
    ...
    public void testFullWorkflow_ShouldResponseConversionException_NoUpdateFile() throws InterruptedException {
        ...
        Assertions.assertThatThrownBy(errorFuture::get)
