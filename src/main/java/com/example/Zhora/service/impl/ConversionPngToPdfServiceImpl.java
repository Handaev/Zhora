...
@Service
public class ConversionPngToPdfServiceImpl extends AbstractConversionServiceImpl {

    private final MinioServiceImpl minioServiceImpl;

    public ConversionPngToPdfServiceImpl(MinioServiceImpl minioService, MinioServiceImpl minioServiceImpl) {
        super(minioService);
